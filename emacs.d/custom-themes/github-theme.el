...
;; The colors in this theme come from the Github palette, which is in
;; the public domain: http://github.freedesktop.org/

;;; Code:

(deftheme github
  "Face colors using the Github palette (light background).
Basic, Font Lock, Isearch, Gnus, Message, Ediff, Flyspell,
Semantic, and Ansi-Color faces are included.")

(let ((class '((class color) (min-colors 89)))
      ;; Github palette colors.
      ...
      (plum-1 "#000000") (plum-2 "#000000") (plum-3 "#000000")
      (red-1 "#ef2929")  (red-2 "#cc0000")  (red-3 "#a40000")
      (alum-1 "#eeeeec") (alum-2 "#d3d7cf") (alum-3 "#babdb6")
      (alum-4 "#888a85") (alum-5 "#5f615c") (alum-6 "#2e3436")
      ;; Not in Github palette; used for better contrast.
      (cham-4 "#346604") (blue-0 "#8cc4ff") (orange-4 "#b35000")
      ; added
      (matt-black "#000000") (matt-pink "#D81745") (matt-blue "#0086B3"))
  ...
  (custom-theme-set-faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,matt-blue))))
   ...
   `(font-lock-keyword-face ((,class (:weight bold :foreground ,matt-black))))
   `(font-lock-string-face ((,class (:foreground ,matt-pink))))
   `(font-lock-type-face ((,class (:foreground ,blue-3))))
   `(font-lock-variable-name-face ((,class (:foreground ,matt-black))))
