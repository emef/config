...
return {
  {
    ...
    keys = {
      ...
      { "<leader>,",       my_buffers,                                                                               desc = "Buffers" },
      { "<F5>",            my_buffers,                                                                               desc = "Buffers" },
      { "<leader>fb",      my_buffers,                                                                               desc = "Buffers" },
      { "<leader>/",       function() Snacks.picker.git_grep() end,                                                  desc = "Git Grep" },
      { "<leader>:",       function() Snacks.picker.command_history() end,                                           desc = "Command History" },
      { "<leader>n",       function() Snacks.picker.notifications() end,                                             desc = "Notification History" },
      -- find
      { "<leader>fc",      function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end,                   desc = "Find Config File" },
      { "<leader>fn",      function() Snacks.picker.files({ cwd = vim.fn.expand "~/Documents/obsidian/magic" }) end, desc = "Find Config File" },
      { "<leader>ff",      my_files,                                                                                 desc = "Find Files" },
      { "<F4>",            my_files,                                                                                 desc = "Find Files" },
